...
def get_employs(employers_names: list):
    """
...
def get_employ_vacancies(employer_id):
    """
    Функция получения вакансий у компании
    :param employer_id:
    :return: dict
    """
    params = {
...
def create_table_employ(params, employers):
            ...
            for emp_vac in employer_vacancies:
                try:
                    ...
                    if emp_vac['snippet']['responsibility'] is None:
                        ...
                        responsibility = emp_vac['snippet']['responsibility']
                cur.execute(f"""
                INSERT INTO  {table_name}(id_employer, name_employer, 
                title_vacancy, city, salary, url_vacancy, 
